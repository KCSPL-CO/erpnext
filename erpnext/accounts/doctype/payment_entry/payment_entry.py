...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		naming_series: DF.Literal["ACC-PAY-.YYYY.-", "ACC-DRUG-PAY-.YYYY.-", "ACC-LAB-PAY-.YYYY.-", "ACC-SERV-PAY-.YYYY.-", "ACC-CONS-PAY-.YYYY.-", "ACC-RAW-PAY-.YYYY.-", "ACC-PROD-PAY-.YYYY.-", "ACC-SUB-PAY-.YYYY.-", "ACC-DEMO-PAY-.YYYY.-"]
